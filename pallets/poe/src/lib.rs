...
mod pallet_mod {
    ...
    pub type Proofs<T: Config> = StorageMap<
        _, Blake2_128Concat,
        BoundedVec<u8, T::MaxClaimLength>, (T::AccountId, T::BlockNumber),
    >;
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn create_claim(origin: OriginFor<T>, claim: BoundedVec<u8, T::MaxClaimLength>) -> DispatchResult {
            ...
            Proofs::<T>::insert(&claim, (signer.clone(), frame_system::Pallet::<T>::block_number()));
        ...
        #[pallet::call_index(2)]
        #[pallet::weight(0)]
        pub fn transfer_claim(origin: OriginFor<T>, dest: T::AccountId, claim: BoundedVec::<u8, T::MaxClaimLength>) -> DispatchResult {
            let signer = ensure_signed(origin)?;
